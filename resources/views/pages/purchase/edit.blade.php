                                    ...
                                    <form action="{{ route('purchase.update', $purchase->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" name="transno" id="transno" class="form-control" value="{{  $purchase->transno }}" placeholder="No" readonly/>
                                            </div>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-4">
                                                <label class="form-label">Nama</label>
                                                <input type="text" name="name" id="name" class="form-control" value="{{ $purchase->name }}" placeholder="Nama"/>
                                            </div>
                                        </div>
                                        <div class="row mb-5">
                                            <div class="col-md-6">
                                                <label class="form-label">Alamat</label>
                                                <textarea name="address" id="address" class="form-control" placeholder="Alamat">{{ $purchase->address }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <table id="tableTransaction" class="table">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="total" id="netTotal" value="{{ $purchase->total }}" class="form-control input-float" placeholder="00" readonly/>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                                </tfoot>
