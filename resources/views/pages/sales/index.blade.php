                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            ...
                            <a href="{{ route('sales.create') }}" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto add-datatable">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="DataTables" class="data-table nowrap w-100">
                            ...
                            <tr>
                                ...
                                <th class="text-small text-uppercase">Code</th>
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr data-id="{{$item->id}}">
                                        ...
                                        <td>{{ $item->total }}</td>
                                        <td>
                                            <a href="{{ route('sales.invoice', ['id' => $item->id]) }}" target="blank" class="btn btn-sm btn-icon btn-icon-only btn-info mb-1" data-bs-delay="0" data-bs-toggle="tooltip" data-bs-placement="top" title="Show">
                                                <i data-acorn-icon="print"></i>
                                            </a>
                                            <a href="{{ route('sales.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-icon btn-icon-only btn-primary mb-1" data-bs-delay="0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                <i data-acorn-icon="edit"></i>
                                            </a>
                                            {{-- Delete --}}
                                            <form action="{{ route('sales.destroy', ['id' => $item->id]) }}" method="POST" class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
