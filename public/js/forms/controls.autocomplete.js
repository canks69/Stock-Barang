...
class AutocompleteControls {
  ...
  _initStrictArray() {
    ...
    }else if(document.getElementById('customerCode') !== null){
      if(localStorage.getItem('customer') !== null){
        this._getCustomerCode();
      }
      new AutocompleteCustom('customerCode', 'customerCodeResults', {
        data: {
          src: JSON.parse(localStorage.getItem('customer')),
        },
        placeHolder: 'Search',
        searchEngine: 'strict',
        highlight: true,
    ...
    if(document.getElementById('customerRefresh')){
      document.getElementById('customerRefresh').addEventListener('click', this._getCustomerCode());
    }
